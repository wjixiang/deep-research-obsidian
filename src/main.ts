...
import { deepResearchObSettings, deepResearchObSettingTab, DEFAULT_SETTINGS } from './setting';
...
export default class deepResearchOb extends Plugin {
	...
	async init() {
		...
		this.queryFn = (query: string) => {
			return new Promise((resolve)=> {
				resolve("teach me basic Quantitative Investment Strategies") // temporary
			})
		}
		this.deepReserachAPI = new deepReserachAPI(this.queryFn, this.settings)
	}
